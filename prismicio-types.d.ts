...
/**
 * Primary content in *FeaturedEvent → Primary*
 */
export interface FeaturedEventSliceDefaultPrimary {
  /**
   * Event Date field in *FeaturedEvent → Primary*
   *
   * - **Field Type**: Date
   * - **Placeholder**: *None*
   * - **API ID Path**: featured_event.primary.event_date
   * - **Documentation**: https://prismic.io/docs/field#date
   */
  event_date: prismic.DateField;

  /**
   * Event Title field in *FeaturedEvent → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: featured_event.primary.event_title
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  event_title: prismic.RichTextField;

  /**
   * Event Program field in *FeaturedEvent → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **Default Value**: Revolve Sound
   * - **API ID Path**: featured_event.primary.event_program
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  event_program: prismic.SelectField<
    | "Revolve Sound"
    | "Revolve Screens"
    | "Queer Artist Meetup"
    | "Current Exhibition",
...
/**
 * Default variation for FeaturedEvent Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type FeaturedEventSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<FeaturedEventSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *FeaturedEvent*
 */
type FeaturedEventSliceVariation = FeaturedEventSliceDefault;

/**
 * FeaturedEvent Shared Slice
 *
 * - **API ID**: `featured_event`
 * - **Description**: FeaturedEvent
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type FeaturedEventSlice = prismic.SharedSlice<
  "featured_event",
  FeaturedEventSliceVariation
>;
